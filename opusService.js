...
function createPatient(req, res, next) {
    db.one('INSERT INTO Patient(name, sex, DOB, city, region, ethnicity, lang) VALUES (${name}, ${sex}, ${DOB}, ${city}, ${region}, ${ethnicity}, ${lang} RETURNING registrationNumber', req.body)
        .then(data => {
            res.send(data);
        })
        .catch(err => {
